...
export default function TrackerApp({ onSignOut }: { onSignOut: () => Promise<unknown> }) {
  ...
  const displayedRosterEmployees = rosterExpanded ? rosterEmployees : rosterEmployees.slice(0, 9);
